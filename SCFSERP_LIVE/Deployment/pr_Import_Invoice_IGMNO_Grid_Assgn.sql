-- EXEC [pr_Import_Invoice_IGMNO_Grid_Assgn] '2293370', '418', 0
...
BEGIN
	...
	HANDL_IGST_AMT,TRANCGSTAMT,TRANSGSTAMT,TRANIGSTAMT,TRAND_COVID_DISC_AMT,TRANDADONAMT)
	...
	FROM         dbo.OPENSHEETMASTER INNER JOIN
						 ...
						 dbo.CATEGORY_ADDRESS_DETAIL ON dbo.OPENSHEETMASTER.OSBBCHACATEAID = dbo.CATEGORY_ADDRESS_DETAIL.CATEAID  LEFT OUTER JOIN
...
--ACTUAL STUFF INVOICE DETAIL
	...
	HANDL_TAXABLE_AMT,STRG_CGST_EXPRN,STRG_SGST_EXPRN,STRG_IGST_EXPRN,STRG_CGST_AMT,STRG_SGST_AMT,
	STRG_IGST_AMT,HANDL_CGST_EXPRN,HANDL_SGST_EXPRN,HANDL_IGST_EXPRN,HANDL_CGST_AMT,HANDL_SGST_AMT,
	HANDL_IGST_AMT,TRANCGSTAMT,TRANSGSTAMT,TRANIGSTAMT,TRAND_COVID_DISC_AMT,TRANBTYPE, TRANDADONAMT)
	...
	SELECT     dbo.TRANSACTIONMASTER.TRANREFID, dbo.TRANSACTIONMASTER.TRANREFNAME, dbo.TRANSACTIONDETAIL.TRANDREFNO AS BOENO, 
                         ...
                         HANDL_SGST_AMT, HANDL_IGST_AMT,TRANCGSTAMT,TRANSGSTAMT,TRANIGSTAMT,TRAND_COVID_DISC_AMT,TRANBTYPE,TRANDADONAMT
