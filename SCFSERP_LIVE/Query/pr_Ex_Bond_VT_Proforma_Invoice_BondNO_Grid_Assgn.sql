/*
EXEC [pr_Ex_Bond_VT_Proforma_Invoice_BondNO_Grid_Assgn] @userid = 'ck', @PVTDID =1, @PEBNDID =14000, @PBNDID =5750, @PTRANMID = 0, @PSDATE = '2022-09-30', @PEDATE = '2022-10-13', @PBCHAID = 53617, @PBCATEAID = 860, @PTARIFFMID = 11, @PSLABTID = 2, @PCHRGTYPE = 1, 



@PRDTID = 2, @PYRDID = 1, @POPRID = 3, @PHNDTID  = 1, @PCNTSID = 2, @PQTY  = 2, @PNOP = 45, @PRATE  = 33, @PAMT = 2970, @PHTYPE = 1
EXEC [pr_Ex_Bond_VT_Proforma_Invoice_BondNO_Grid_Assgn] @userid = 'ck', @PVTDID =3, @PEBNDID =0, @PBNDID =0, @PTRANMID =14725

EXEC [pr_Ex_Bond_VT_Proforma_Invoice_BondNO_Grid_Assgn] @userid = 'ck', @PVTDID =26, @PEBNDID =14014, @PBNDID =5722, @PTRANMID = 14753, @PSDATE = '2022-10-15', @PEDATE = '2022-11-11', @PBCHAID = 24624, @PBCATEAID = 5002, @PTARIFFMID = 7, @PSLABTID = 2, @PCHRGTYPE 

= 1, @PRDTID = 2, @PYRDID = 1, @POPRID = 3, @PHNDTID  = 0, @PCNTSID = 2, @PQTY  = 4, @PNOP = 4, @PRATE  = 0, @PAMT = 0, @PHTYPE = 0, @PTAXTYPE = 1, @PVTSPC = 23
EXEC [pr_Ex_Bond_VT_Proforma_Invoice_BondNO_Grid_Assgn] @userid = 'ck', @PVTDID =26, @PEBNDID =14014, @PBNDID =5722, @PTRANMID = 14753, @PSDATE = '2022-11-10', @PEDATE = '2022-11-10', @PBCHAID = 24624, @PBCATEAID = 5002, @PTARIFFMID = 15, @PSLABTID = 4, @PCHRGTYPE

 = 1, @PRDTID = 2, @PYRDID = 1, @POPRID = 3, @PHNDTID  = 0, @PCNTSID = 2, @PQTY  = 0, @PNOP = 4, @PRATE  = 0.15, @PAMT = 0, @PHTYPE = 0, @PTAXTYPE = 1, @PVTSPC = 23
EXEC [pr_Ex_Bond_VT_Proforma_Invoice_BondNO_Grid_Assgn] @userid = 'ck', @PVTDID =60, @PEBNDID =14007, @PBNDID =5700, @PTRANMID = 0, @PSDATE = '2022-10-20', @PEDATE = '2022-10-19', @PBCHAID = 2386, @PBCATEAID = 66, @PTARIFFMID = 12, @PSLABTID = 4, @PCHRGTYPE = 1, @

PRDTID = 2, @PYRDID = 1, @POPRID = 3, @PHNDTID  = 0, @PCNTSID = 2, @PQTY  = 0, @PNOP = 140, @PRATE  = 0.15, @PAMT = 0, @PHTYPE = 0, @PTAXTYPE = 1, @PVTSPC = 6

EXEC [pr_Ex_Bond_VT_Proforma_Invoice_BondNO_Grid_Assgn] @userid = 'ck', @PVTDID =335, @PEBNDID =14308, @PBNDID =5782, @PTRANMID = 0, @PSDATE = '2023-03-02', @PEDATE = '2023-03-21', @PBCHAID = 1931, @PBCATEAID = 2893, @PTARIFFMID = 9, @PSLABTID = 2, @PCHRGTYPE = 1,
 @PRDTID = 2, @PYRDID = 1, @POPRID = 3, @PHNDTID  = 0, @PCNTSID = 2, @PQTY  = 3, @PNOP = 7, @PRATE  = 75, @PAMT = 2925, @PHTYPE = 0, @PTAXTYPE = 1, @PVTSPC = 13
	EXEC [pr_Ex_Bond_VT_Proforma_Invoice_BondNO_Grid_Assgn] @userid = 'ck', @PVTDID =335, @PEBNDID =14308, @PBNDID =5782, @PTRANMID = 0, @PSDATE = '2023-02-27', @PEDATE = '2023-03-18', @PBCHAID = 1931, @PBCATEAID = 2893, @PTARIFFMID = 9, @PSLABTID = 4, @PCHRGTYPE = 1
, @PRDTID = 2, @PYRDID = 1, @POPRID = 3, @PHNDTID  = 0, @PCNTSID = 2, @PQTY  = 3, @PNOP = 7, @PRATE  = 0.15, @PAMT = 1111, @PHTYPE = 0, @PTAXTYPE = 1, @PVTSPC = 13
*/
-- delete tmp_usr_proforma_exbond_vtinv_add_dtl
-- delete BONDPerformaTRANSACTIONMASTER
-- select * From tmp_usr_proforma_exbond_vtinv_add_dtl
-- select * from BONDMASTER
CREATE PROCEDURE [dbo].[pr_Ex_Bond_VT_Proforma_Invoice_BondNO_Grid_Assgn]  /* CHANGE */
		@userid varchar(50),
		@PVTDID int, 
		@PEBNDID int, 
		@PBNDID int, 
...
begin
	delete tmp_usr_proforma_exbond_vtinv_add_dtl where userid = @userid and tariffmid = @PTARIFFMID and slabtid= @PSLABTID and VTDID = @LVTDID
	...
	and b.ebndid in (select ebndid from BONDPerformaTRANSACTIONDetail where bndid = @LBNDID)
	
	INSERT INTO tmp_usr_proforma_exbond_vtinv_add_dtl(EBNDID,TRANDEBNDNO ,VTDID ,VTDNO ,
	...
	FROM         dbo.VW_BOND_VT_PROFORMA_INVOICE_SBILL_NO_CBX_ASSGN_01 RIGHT OUTER JOIN     DBO.BONDVEHICLETICKETDETAIL ON							 
							 dbo.VW_BOND_VT_PROFORMA_INVOICE_SBILL_NO_CBX_ASSGN_01.EBNDID = dbo.BONDVEHICLETICKETDETAIL.EBNDID
							 and dbo.VW_BOND_VT_PROFORMA_INVOICE_SBILL_NO_CBX_ASSGN_01.VTDID = dbo.BONDVEHICLETICKETDETAIL.VTDID
							 and dbo.VW_BOND_VT_PROFORMA_INVOICE_SBILL_NO_CBX_ASSGN_01.SLABTID = @PSLABTID  
							 and dbo.VW_BOND_VT_PROFORMA_INVOICE_SBILL_NO_CBX_ASSGN_01.TRANHTYPE = @PHNDTID RIGHT OUTER JOIN DBO.EXBONDMASTER ON							 
							 ...
							 --BONDYARDMASTER ON BONDYARDMASTER.YRDID = @PYRDID
	WHERE     ((ISNULL(dbo.VW_BOND_VT_PROFORMA_INVOICE_SBILL_NO_CBX_ASSGN_01.TRANHTYPE, -1) = -1)	or 
	(ISNULL(dbo.VW_BOND_VT_PROFORMA_INVOICE_SBILL_NO_CBX_ASSGN_01.VTDID, 0) = 0))
	...
	dbo.VW_BOND_VT_PROFORMA_INVOICE_SBILL_NO_CBX_ASSGN_01.SLABTID,  dbo.CONTAINERSIZEMASTER.CONTNRSDESC, isnull(STATETYPE,0) ,
	...
	set TRANDGAMT = 0 , TRANDNAMT =0 , TRAND_TAXABLE_AMT=0,
		...
		TRAND_IGST_AMT=0
		-- select *
	from tmp_usr_proforma_exbond_vtinv_add_dtl a 
		join BONDPerformaTRANSACTIONDetail b on a.bndid = b.bndid
	...
	TRANDID,TRANDSAMT,TRANDHAMT,TRANDIAMT,TRANDNAMT, STATETYPE, TRAND_HSN_CODE, INS_TRAND_HSN_CODE ,TRAND_TAXABLE_AMT,
		...
		CONTNRSID,YRDID,TRANCTYPE,TRANOTYPE,TRANHTYPE, YRDDESC ,TRANCTYPEDESC ,TRANOTYPEDESC , TRANHTYPEDESC, EBNDID, TRANDEBNDNO ,
		TARIFFMID, TARIFFDESC ,  SLABTDESC , PERIODTID , PERIODTDESC,TRANDGAMT , EXBNDVTSPC
	from tmp_usr_proforma_exbond_vtinv_add_dtl (nolock)
	where userid = @userid
end
else
begin
	delete tmp_usr_proforma_exbond_vtinv_add_dtl where userid = @userid and TRANMID = @LTRANMID
end
...
SELECT     dbo.BONDPerformaTRANSACTIONDetail.VTDID, dbo.BONDVEHICLETICKETDETAIL.VTDNO, dbo.BONDPerformaTRANSACTIONDetail.TRANDBNDNO AS TRANDBNDNO, dbo.CONTAINERSIZEMASTER.CONTNRSDESC,
			...
			convert(varchar,dbo.BONDPerformaTRANSACTIONDetail.TRANSEDATE,103) , convert(varchar,dbo.BONDPerformaTRANSACTIONDetail.TRANIFDATE,103) , 
					  ...
					  CASE WHEN dbo.BONDPerformaTRANSACTIONDetail.TRANHTYPE =0  THEN 'NR'
					  WHEN dbo.BONDPerformaTRANSACTIONDetail.TRANHTYPE =1  THEN 'Loading'
					  WHEN dbo.BONDPerformaTRANSACTIONDetail.TRANHTYPE =2  THEN 'Unloading' ELSE '' END ,BONDPerformaTRANSACTIONDetail.EBNDID,TRANDEBNDNO,dbo.BONDPerformaTRANSACTIONDetail.TARIFFMID , isnull(TARIFFMDESC,'') , 
					  SLABTDESC , 
...
FROM            dbo.BONDPerformaTRANSACTIONDetail INNER JOIN
						DBO.BONDVEHICLETICKETDETAIL ON dbo.BONDPerformaTRANSACTIONDetail.VTDID = dbo.BONDVEHICLETICKETDETAIL.VTDID INNER JOIN
