-- EXEC [PR_NONPNR_DASHBOARD_DETAILS] '2021-10-20' , '2021-10-20', 1
alter proc [dbo].[PR_NONPNR_DASHBOARD_DETAILS]
@PFDT datetime,
@PTDT datetime,
@PSDPTID int
as
begin
	...
	select	1, 'NON-PNR - GATEIN', SUM(CASE WHEN CONTNRSID = 3 THEN 1 ELSE 0 END) '20"', 
	...
	insert into @temptable
	select 2, 'NON-PNR - GATEOUT', SUM(CASE WHEN CONTNRSID = 3 THEN 1 ELSE 0 END) '20"', 
			SUM(CASE WHEN CONTNRSID = 4 THEN 1 ELSE 0 END) '40"',
			SUM(CASE WHEN CONTNRSID = 5 THEN 1 ELSE 0 END) '45"',
			0 'TUES'
