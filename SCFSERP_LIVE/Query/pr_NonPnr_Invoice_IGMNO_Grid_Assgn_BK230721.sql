...
IF @LTRANMID  = 0  
	...
	SELECT DISTINCT 
                         ISNULL(dbo.GATEINDETAIL.CHAID,0),ISNULL(dbo.GATEINDETAIL.CHANAME ,''), ISNULL(dbo.GATEINDETAIL.BOENO,''),  
						...
						ISNULL(dbo.GATEINDETAIL.GPETYPE,0),ISNULL(dbo.GATEINDETAIL.GPSTYPE,0),ISNULL(dbo.GATEINDETAIL.GPWTYPE,0),
                         ...
                         dbo.CATEGORYMASTER ON dbo.GATEINDETAIL.CHAID = CATEGORYMASTER.CATEID INNER Join 
						 dbo.TARIFFMASTER ON TARIFFMASTER.TARIFFMID = CATEGORYMASTER.TARIFFMID INNER Join  
