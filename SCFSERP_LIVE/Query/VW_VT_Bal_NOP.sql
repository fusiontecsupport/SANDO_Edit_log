...
join BONDTRANSACTIONDETAIL t2(nolock) on t1.BNDID = t2.BNDID and  e.BNDID = t2.BNDID and t1.TRANMID > t2.TRANMID and t2.slabtid = 2
where e.DISPSTATUS = 0
--and b.BNDDNO = '2002038260'
group by   b.bndid,  b.BNDDNO,b.BNDNOP , t1.TRANMID, BalBNDQty