/*
EXEC [pr_Bond_Manual_Invoice_BondNO_Grid_Assgn] @userid = 'ck', @PBNDID =5698, @PTRANMID = 0, @PSDATE = '2022-10-01', @PEDATE = '2023-01-31', @PBCHAID = 53617, @PBCATEAID = 860, @PTARIFFMID = 2, @PSLABTID = 2, @PCHRGTYPE = 1, @PRDTID = 2, @PYRDID = 1, @PO
PRID = 3, @PHNDTID  = 0, @PCNTSID = 2, @PQTY  = 17, @PNOP = 50, @PRATE  = 50, @PAMT = 42500, @PTAXTYPE = 2, @PBILLDESC = 'Storage'
exec pr_Bond_Manual_Invoice_BondNO_Grid_Assgn @userid = 'ck', @PBNDID=5698, @PTRANMID=14754
*/
-- delete tmp_usr_bond_add_dtl
-- delete bondtransactionmaster
-- select * From tmp_usr_bond_add_dtl
-- select * from BONDMASTER
alter PROCEDURE [dbo].[pr_Bond_Manual_Invoice_BondNO_Grid_Assgn]  /* CHANGE */
		@userid varchar(50),
		@PBNDID int, 
		@PTRANMID INT,
...
begin
	...
	INS_TRAND_IGST_AMT,TRANDCIFAMT ,TRANDDTYAMT ,TRANDINSAMT,
		...
		TARIFFMID, TARIFFDESC ,  SLABTDESC , PERIODTID , PERIODTDESC, TRANDGAMT, userid, BILLDESC
	)
	...
	TRANDID,TRANDSAMT,TRANDHAMT,TRANDIAMT,TRANDNAMT, STATETYPE, TRAND_HSN_CODE, INS_TRAND_HSN_CODE ,TRAND_TAXABLE_AMT,
		...
		INS_TRAND_IGST_AMT,TRANDCIFAMT ,TRANDDTYAMT ,TRANDINSAMT,
		CONTNRSID,YRDID,TRANCTYPE,TRANOTYPE,TRANHTYPE, YRDDESC ,TRANCTYPEDESC ,TRANOTYPEDESC , TRANHTYPEDESC, EBNDID, TRANDEBNDNO ,
		TARIFFMID, TARIFFDESC ,  SLABTDESC , PERIODTID , PERIODTDESC,TRANDGAMT, BILLDESC
	)
...
SELECT     dbo.BONDTRANSACTIONDETAIL.TRANDBNDNO AS TRANDBNDNO, dbo.CONTAINERSIZEMASTER.CONTNRSDESC,
			...
			convert(varchar,dbo.BONDTRANSACTIONDETAIL.TRANSEDATE,103) , convert(varchar,dbo.BONDTRANSACTIONDETAIL.TRANIFDATE,103) , 
					  ...
					  SLABTDESC , 
						  ...
						  TRANDGAMT, BONDTRANSACTIONDETAIL.BILLDESC
