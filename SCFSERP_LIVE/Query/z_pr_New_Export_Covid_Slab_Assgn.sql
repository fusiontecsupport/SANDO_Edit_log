alter PROCEDURE [dbo].[z_pr_New_Export_Covid_Slab_Assgn]  @PKUSRID varchar(100), @PSDATE smalldatetime, @PEDATE smalldatetime,
...
BEGIN
	...
	WHILE (@count <  @DIFFDAYS)
		BEGIN
			...
			Set @scount = @count+1
			EXEC z_pr_New_Export_Covid_Slab_Rate_Assgn @PKUSRID, @PTARIFFMID,@PSTMRID,@PCHRGETYPE,@PSLABTID,@scount,@PCONTNRSID,@PSLABHTYPE,@PCHRGDATE 
