...
FROM  TRANSACTIONMASTER (nolock) Inner Join  TRANSACTIONDETAIL (nolock) On TRANSACTIONMASTER.TRANMID = TRANSACTIONDETAIL.TRANMID inner JOIn 
GATEINDETAIL (NOLOCK) on TRANSACTIONDETAIL.TRANDREFID = GATEINDETAIL.GIDID  and TRANSACTIONMASTER.SDPTID = GATEINDETAIL.SDPTID inner JOIN 
CONTAINERSIZEMASTER (nolock) On GATEINDETAIL.CONTNRSID = CONTAINERSIZEMASTER.CONTNRSID inner Join 
