CREATE PROCEDURE [dbo].[pr_Search_Import_Performa_Invoice]  /* CHANGE */
...
set @LEDate = @PEDate
   ...
   TRANDNO, TRANNO,isnull(TRANREFNAME, TRANREFNAME),0,TRANCGSTAMT+TRANSGSTAMT+TRANIGSTAMT,DISPSTATUS, (CASE WHEN len(IRNNO) > 0 THEN 1 ELSE 0 END), TRANMID
