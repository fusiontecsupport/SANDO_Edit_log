  ...
  Plugin.prototype = {
    ...
    search: function (table, tableSortContainer) {
      ...
      if (table.hasClass('table-sort-search')) {
        ...
        var search        = $('<div class="table-sort-search-container"><input class="table-sort-search-input" type="text" placeholder="Search Details ...."></div>');
        var searchInput   = search.find('.table-sort-search-input');
        var tbody = table.find('thead .me');
