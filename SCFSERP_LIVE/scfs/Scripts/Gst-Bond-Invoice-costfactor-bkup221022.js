...
function total() {  
    ...
    $(".TRANDIDS").each(function () {
        ...
        if (ckb == true) {
            ...
            var TRANDCGSTAMT = $(".TRAND_CGST_AMT")[i].value.toFixed(0);
            var TRANDSGSTAMT = $(".TRAND_SGST_AMT")[i].value.toFixed(0);
            var TRANDIGSTAMT = $(".TRAND_IGST_AMT")[i].value.toFixed(0);
            //alert(TRANDCGSTAMT);
            //alert(TRANDSGSTAMT);
            //alert(TRANDICGSTAMT);
   ...
   // Trand_CGSTAmt = eval(((Trand_TaxableAmt * Trand_CGSTExprn) / 100));
    ...
    round = parseFloat(Trand_TaxableAmt) + parseFloat(Ins_Trand_TaxableAmt) + parseFloat(TOTCGSTAMT) + parseFloat(TOTSGSTAMT) + parseFloat(TOTIGSTAMT);
