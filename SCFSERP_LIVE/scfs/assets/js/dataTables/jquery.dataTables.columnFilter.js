...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateDateRangeInput(oTable) {
            ...
            //th.html(_fnRangeLabelPart(0));
            var sFromId = oTable.attr("id") + '_range_from_' + i;
            var from = $('<input type="text" name="from_date" class="date_range_filter form-control" id="' + sFromId + '" rel="' + i + '"/>');
            from.datepicker();
            //th.append(from);
            //th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input type="text"  name="from_to" class="date_range_filter form-control" id="' + sToId + '" rel="' + i + '"/>');
            //th.append(to);
            //th.append(_fnRangeLabelPart(2));
        ...
        var defaults = {
            ...
            iFilteringDelay: 500,
            aoColumns: null,
            sRangeFormat: "<div class='dtrange'><div class='frm'>From</div><div class='frm'>{from}</div><div class='frm'> to  </div><div class='frm'> {to} </div></div>",
            sDateFromToken: "from",
            sDateToToken: "to"
        };
