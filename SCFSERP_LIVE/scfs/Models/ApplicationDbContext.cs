...
namespace scfs_erp.Models
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public IDbSet<MenuRoleMaster> MenuRoleMaster { get; set; }
    //    public IDbSet<MenuRoleMaster> MenuRoleMaster { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<GateInDetail>().Property(x => x.GPWGHT).HasPrecision(18, 4);
            //modelBuilder.Entity<ExportShippingBillMaster>().Property(x => x.ESBMQTY).HasPrecision(18, 4);
            // Keep this:
