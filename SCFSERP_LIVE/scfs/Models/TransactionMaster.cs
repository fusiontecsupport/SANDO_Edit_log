...
namespace scfs_erp.Models
{
    ...
    public class TransactionMaster
    {
        ...
        public String SLABNARN_HANDLDESC { get; set; }
        public String SLABNARN_ADNLDESC { get; set; }
        public int SLABNARN_STS { get; set; }
        public int TRAN_PULSE_STRG_TYPE { get; set; }
        public int TRANTALLYCHAID { get; set; }
        public string TRANTALLYCHANAME { get; set; }
        public int TCATEAID { get; set; }
        public string TCATEAGSTNO { get; set; }
