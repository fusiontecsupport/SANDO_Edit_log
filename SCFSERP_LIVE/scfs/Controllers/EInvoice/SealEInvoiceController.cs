...
namespace scfs.Controllers.EInvoice
{
    ...
    public class SealEInvoiceController : Controller
    {
        ...
        [Authorize(Roles = "SealEInvoicePrint")]
        public void UPrintView(int? id = 0)
        {
            ...
            if (TMPRPT_IDS == "Successfully Added")
            {
                ...
                rptname = "E_2002.rpt";
                hstr = "{VW_EXPORT_EINVOICE_GST_INVOICE_DOSPRINT_01.KUSRID} = '" + Session["CUSRID"].ToString() + "' AND {VW_EXPORT_EINVOICE_GST_INVOICE_DOSPRINT_01.TRANMID} = " + id;
        ...
        [Authorize(Roles = "SealEInvoiceUpload")]
