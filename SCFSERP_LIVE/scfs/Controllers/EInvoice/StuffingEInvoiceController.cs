...
namespace scfs.Controllers.EInvoice
{
    ...
    public class StuffingEInvoiceController : Controller
    {
        ...
        [Authorize(Roles = "StuffingEInvoiceUpload")]
        ...
        [Authorize(Roles = "StuffingEInvoicePrint")]
        public void UPrintView(int? id = 0)
        {
            ...
            if (TMPRPT_IDS == "Successfully Added")
            {
                ...
                rptname = "E_2001.rpt";
                hstr = "{VW_EXPORT_EINVOICE_GST_INVOICE_DOSPRINT_01.KUSRID} = '" + Session["CUSRID"].ToString() + "' AND {VW_EXPORT_EINVOICE_GST_INVOICE_DOSPRINT_01.TRANMID} = " + id;// + " AND {?Pm-VW_EXPORT_INVOICE_DOSPRINT_03.TRANMID} = " + id;
