...
{
    [SessionExpire]
    public class BOESearchDetailsController : Controller
    {
        // GET: BOESearchDetails
        SCFSERPContext context = new SCFSERPContext();
        //[Authorize(Roles = "BOESearchDetailsView")]
        ...
        {
            var query = context.Database.SqlQuery<pr_BOE_Search_Container_No_Assgn_Result>("EXEC pr_BOE_Search_Container_No_Assgn @PBOENo = '" + id + "'").ToList();
